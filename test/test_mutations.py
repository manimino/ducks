...
def test_many_gets(box_class, n_items):
    ...
    for _ in range(4):
        ...
        assert (
            len(f.find(match={"n": {"in": [1, 2, 3, 4, 5]}, f5: {"in": [3, 4]}})) == 2
        )
        ...
        assert (
            len(
                f.find(
                    match={"n": {"in": [1, 2, 3, 4, 5]}}, exclude={f5: {"in": [1, 2]}}
                )
            )
            == 3
        )
        assert (
            len(
                f.find(
                    match={"n": {"in": [6, 7, 8]}}, exclude={"n": 3, f5: {"in": [1, 2]}}
                )
            )
            == 1
        )
        ...
        assert (
            len(
                f.find(
                    match={f5: 1, "n": -1000}, exclude={"n": -1000, f5: {"in": [3, 4]}}
                )
            )
            == 0
        )
